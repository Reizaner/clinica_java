...
public class Especialidades extends Conexion{
    ...
    public boolean isNew(Especialidad c) {
        ...
        try {
            ...
            rs.updateString("descripcion", c.getEspecialidad());
     ...
     * @return true=registra, false=presencia de error
     */
    public boolean isUpdate(Especialidad c) {
        boolean isOk = false;
        try {
            Statement st = (Statement) this.getCn().createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
                    ResultSet.CONCUR_UPDATABLE);
     ...
     * @return true=registra, false=presencia de error
     */
    public boolean isDelete(Especialidad c) {
        boolean isOk = false;
        try {
            Statement st = (Statement) this.getCn().createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
                    ResultSet.CONCUR_UPDATABLE);
     ...
     * @return ArrayList
     */
    public ArrayList<Especialidad> listObraSocial(String query) {
    ...
    public Especialidad getEspecialidad(int id) {
        ...
        if (isOkConexion()) {
            ...
            ArrayList<Especialidad> pacienteList = listObraSocial(query);
