...
import static sistema_clinica_araujo.JFrame_Sistema.fe;
...
public class FrmTurnosProfesional extends FrmIntern {
    ...
    public void setIdProf(int id){
        ...
        //turnos
        /**
     * Método para cargar los turnos del profesional en la tabla.
     * Se ejecuta en un hilo separado para no bloquear la interfaz gráfica del usuario.
     * Desactiva el botón de edición mientras carga los turnos y lo vuelve a activar una vez completado.
     */
    private void _loadTurnos() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (cnx.isOkConexion()) {
                    // Obtiene la lista de turnos del profesional
    ...
    /**
     * Método para cargar la historia clínica del paciente seleccionado.
     * Actualmente muestra un mensaje de aviso indicando que la función está en desarrollo.
     */
    private void _loadHistoriaClinica() {
        ...
        if (dir.exists() && dir.isDirectory()) {
            ...
            // Busca el archivo de historia clínica en el directorio
            if (archivos != null) {
     ...
     * Verifica si la fecha y el estado del turno son válidos.
     *
     * @param t El objeto Turno a validar.
    ...
    /**
     * Método para obtener un turno desde el formulario.
     *
     * @return Un objeto Turno con los datos del formulario.
     */
    ...
    /**
     * Método para establecer los datos de un turno y un paciente en el formulario.
     *
     * @param t El objeto Turno con los datos del turno.
     * @param p El objeto Paciente con los datos del paciente.
     */
     ...
     * Obtiene los datos del turno y del paciente seleccionados y los establece en el formulario.
     */
    ...
    /**
     * Método para filtrar los datos de la tabla basado en un texto.
     *
     * @param texto El texto a usar para filtrar las filas de la tabla.
     */
     ...
     * Verifica si el turno es válido antes de actualizarlo.
     *
     * @return true si el turno se actualizó correctamente, false de lo contrario.
     */
