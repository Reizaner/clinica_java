...
public class FrmHorarios extends FrmIntern {
    ...
    /**
     * Carga los horarios desde la base de datos y los muestra en la tabla.
     ...
     * Verifica que la descripción no esté vacía y que se haya ingresado un orden válido.
     *
     * @param hor El objeto Horario a validar.
    ...
    /**
     * Obtiene los datos de un horario desde el formulario.
     *
     * @return Un objeto Horario con los datos del formulario.
     */
    ...
    /**
     * Establece los datos de un horario en el formulario.
     *
     * @param hor El objeto Horario cuyos datos se establecerán en el formulario.
     */
    ...
    /**
     * Selecciona una fila de la tabla y carga los datos del horario correspondiente en el formulario.
     */
     ...
     * Verifica si los datos del horario son válidos antes de agregar.
     *
    ...
    /**
     * Actualiza los datos de un horario en la base de datos.
     * Verifica si los datos del horario son válidos antes de actualizar.
     *
     ...
     * Verifica si los datos del horario son válidos y pide confirmación antes de eliminar.
     *
