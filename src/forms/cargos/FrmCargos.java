...
public class FrmCargos extends FrmIntern {
    ...
    /**
     * Método para cargar los cargos desde la base de datos.
    ...
    /**
     * Método para validar los datos de un cargo.
     * Verifica que la descripción del cargo no esté vacía.
     *
     * @param esp El objeto Cargo a validar.
    ...
    /**
     * Método para obtener los datos de un cargo desde el formulario.
     *
     * @return Un objeto Cargo con los datos del formulario.
     */
    ...
    /**
     * Método para establecer los datos de un cargo en el formulario.
     *
     * @param esp El objeto Cargo cuyos datos se establecerán en el formulario.
     */
    ...
    /**
     * Método para seleccionar una fila de la tabla y cargar los datos del cargo correspondiente en el formulario.
     */
    ...
    /**
     * Método para agregar un nuevo cargo a la base de datos.
     * Verifica si los datos del cargo son válidos antes de agregar.
     *
    ...
    /**
     * Método para actualizar los datos de un cargo en la base de datos.
     * Verifica si los datos del cargo son válidos antes de actualizar.
     *
    ...
    /**
     * Método para eliminar un cargo de la base de datos.
     * Verifica si los datos del cargo son válidos y pide confirmación antes de eliminar.
     *
