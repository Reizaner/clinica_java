...
public class FrmTurnos extends FrmIntern {
    ...
    private Turno _getTurnoForm() {
        ...
        t.setIdProfesional(pnlComboProf_Esp._getProfesionalSelected().getId());
        t.setIdEspecialidad(pnlComboProf_Esp._getEspecialidadSelected().getId());
    ...
    private void _setFormAgendar(Paciente t) {
        ...
        txtDni3.requestFocus();
    }
    
    //formulario de turnos
    private void _setForm(Turno t) {
        txtId1.setText(String.valueOf(t.getId()));
        pnlComboProf_Esp._setProfesionalSelected(t.getIdProfesional() + 1);
        pnlComboProf_Esp._setEspecialidadSelected(t.getIdEspecialidad() + 1);
        if(t.getFecha() == null){
    ...
    private boolean _isUpdate() {
        ...
        if (_isValidate(t)) {
            //Esta en codiciones
            if (JOptionPane.showConfirmDialog(pnlFicha1, "¿Desea Modificar el Turno?.", "Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.NO_OPTION) {
                return isOk;
            }
            Turnos cnx = new Turnos();
            if (cnx.isOkConexion()) {
    ...
    private void initComponents() {
        ...
        pnlComboProf_Esp = new forms.turnos.pnlComboProf_Esp();
            ...
            .addGroup(pnlFicha1Layout.createSequentialGroup()
                .addGroup(pnlFicha1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlFicha1Layout.createSequentialGroup()
                        ...
                        .addGroup(pnlFicha1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlFicha1Layout.createSequentialGroup()
                                .addComponent(pnlComboObrasSociales, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jCheckAtencion)
                                .addGap(118, 118, 118))
                            ...
                            .addComponent(pnlComboProf_Esp, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(pnlFicha1Layout.createSequentialGroup()
                        .addGroup(pnlFicha1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlFicha1Layout.createSequentialGroup()
                                .addGap(28, 28, 28)
            ...
            .addGroup(pnlFicha1Layout.createSequentialGroup()
                ...
                .addGroup(pnlFicha1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlFicha1Layout.createSequentialGroup()
                        ...
                        .addComponent(lblCheck17, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(pnlFicha1Layout.createSequentialGroup()
                        .addComponent(pnlComboProf_Esp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(pnlFicha1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblCheck14, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(pnlComboObrasSociales, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                    .addComponent(jCheckAtencion, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private forms.turnos.pnlComboProf_Esp pnlComboProf_Esp;
