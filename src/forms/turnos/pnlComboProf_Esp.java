...
public class pnlComboProf_Esp extends javax.swing.JPanel {
    ...
    private int idEsp = 0; // ID de la especialidad seleccionada
    ...
    public Especialidad _getEspecialidadSelected() {
        return listesp.get(jComboEsp.getSelectedIndex() - 1);
    }
    ...
    public void _setEspecialidadSelected(int idEsp) {
        ...
        jComboEsp.setSelectedIndex(indexSelectedCombo);
    }
    ...
    public Profesional _getProfesionalSelected() {
        return listprof.get(jComboProf.getSelectedIndex() - 1);
    }
    ...
    public void _setProfesionalSelected(int idProf) {
        ...
        jComboProf.setSelectedIndex(indexSelectedCombo);
    }
