...
public class FrmObraSocial extends FrmIntern {
    ...
    /**
     * Carga las obras sociales desde la base de datos y las muestra en la tabla.
     * Desactiva los botones de nuevo, editar y eliminar mientras carga los datos.
     * La carga se realiza en un hilo separado para no bloquear la interfaz gráfica.
     */
     ...
     *
     * @param o El objeto ObraSocial a validar.
    ...
    /**
     * Obtiene los datos de una obra social desde el formulario.
     *
     * @return Un objeto ObraSocial con los datos del formulario.
     */
    ...
    /**
     * Establece los datos de una obra social en el formulario.
     *
     * @param o El objeto ObraSocial cuyos datos se establecerán en el formulario.
     */
    ...
    /**
     * Selecciona una fila de la tabla y carga los datos de la obra social correspondiente en el formulario.
     */
    ...
    /**
     * Agrega una nueva obra social a la base de datos.
     * Verifica si los datos de la obra social son válidos antes de agregar.
     *
    ...
    /**
     * Actualiza los datos de una obra social en la base de datos.
     * Verifica si los datos de la obra social son válidos antes de actualizar.
     *
     ...
     * Verifica si los datos de la obra social son válidos y pide confirmación antes de eliminar.
     *
